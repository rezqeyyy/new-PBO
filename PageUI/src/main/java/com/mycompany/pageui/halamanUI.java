 ...
 * @author ASUS
 */
public class halamanUI extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(halamanUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
